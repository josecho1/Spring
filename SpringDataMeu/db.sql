...
CREATE TABLE DEPARTMENT (ID INTEGER NOT NULL AUTO_INCREMENT, NAME VARCHAR(255), PRIMARY KEY (ID)) ENGINE=InnoDB DEFAULT CHARSET=latin1;
CREATE TABLE PROJECT (ID INTEGER NOT NULL AUTO_INCREMENT, NAME VARCHAR(255), PRIMARY KEY (ID)) ENGINE=InnoDB DEFAULT CHARSET=latin1 ;
CREATE TABLE PROJECT_EMPLOYEE (EMPLOYEES_ID INTEGER, PROJECTS_ID INTEGER);
CREATE TABLE EMPLOYEE (ID INTEGER NOT NULL AUTO_INCREMENT, NAME VARCHAR(255), SALARY BIGINT, STARTDATE DATE, ADDRESS_ID INTEGER, DEPT_ID INTEGER, MANAGER_ID INTEGER, PRIMARY KEY (ID)) ENGINE=InnoDB DEFAULT CHARSET=latin1;
CREATE TABLE PHONE (ID BIGINT NOT NULL AUTO_INCREMENT, NUMBER VARCHAR(255), TYPE VARCHAR(255), EMPLOYEE_ID INTEGER, PRIMARY KEY (ID)) ENGINE=InnoDB DEFAULT CHARSET=latin1;
CREATE TABLE ADDRESS (ID INTEGER NOT NULL AUTO_INCREMENT, CITY VARCHAR(255), ESTATE VARCHAR(255), STREET VARCHAR(255), ZIP VARCHAR(255), PRIMARY KEY (ID)) ENGINE=InnoDB DEFAULT CHARSET=latin1;


INSERT INTO ADDRESS (ID, CITY, ESTATE, STREET, ZIP) VALUES (1, 'New York', 'NY', '123 Apple Tree Cr.', '10001');
INSERT INTO ADDRESS (ID, CITY, ESTATE, STREET, ZIP) VALUES (2, 'Manhattan', 'NY', '654 Stanton Way.', '10003');
INSERT INTO ADDRESS (ID, CITY, ESTATE, STREET, ZIP) VALUES (3, 'New York', 'NY', '99 Queen St.', '10001');
INSERT INTO ADDRESS (ID, CITY, ESTATE, STREET, ZIP) VALUES (4, 'Redwood Shores', 'CA', '445 McDonell Cr.', '90123');
INSERT INTO ADDRESS (ID, CITY, ESTATE, STREET, ZIP) VALUES (5, 'San Jose', 'CA', '624 Hamilton Dr.', '90123');
INSERT INTO ADDRESS (ID, CITY, ESTATE, STREET, ZIP) VALUES (6, 'San Jose', 'CA', '724 Coventry Rd.', '90123');
INSERT INTO ADDRESS (ID, CITY, ESTATE, STREET, ZIP) VALUES (7, 'San Francisco', 'CA', '77 Manchester Blvd.', '90123');
INSERT INTO ADDRESS (ID, CITY, ESTATE, STREET, ZIP) VALUES (8, 'Moorestown', 'NJ', '53 King St.', '08057');
INSERT INTO ADDRESS (ID, CITY, ESTATE, STREET, ZIP) VALUES (9, 'New York', 'NY', '14 Industrial Ave.', '10001');
INSERT INTO ADDRESS (ID, CITY, ESTATE, STREET, ZIP) VALUES (10, 'Redwood Shores', 'CA', '777 High Tech Ln.', '90123');
